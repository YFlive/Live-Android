...
public class OnekeyShare {
	...
	/**
	 * 分享的时候提示ShareSDK:正在后台操作的Toast设置可以去掉
	 */
	public void setDisappearShareToast(boolean isShow){
		params.put("disappearsharetoast", isShow);
	}
	 ...
	 *  mini program appId
	 * **/
	public void setQQMiniProgramAppid(String qqMiniProgramAppid) {
		params.put("mini_program_appid", qqMiniProgramAppid);
	}

	/** QQ 小程序分享所需参数
	 *  mini program path
	 * **/
	public void setQQMiniProgramPath(String qqMiniProgramPath) {
		params.put("mini_program_path", qqMiniProgramPath);
	}

	/** QQ 小程序分享所需参数
	 *  mini program type
	 * **/
	public void setQQMiniProgramType(String qqMiniProgramType) {
		params.put("mini_program_type", qqMiniProgramType);
	}
