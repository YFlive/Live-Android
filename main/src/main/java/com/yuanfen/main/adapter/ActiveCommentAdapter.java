...
public class ActiveCommentAdapter extends RefreshAdapter<ActiveCommentBean> {
        ...
        mLikeClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(uid) && uid.equals(CommonAppConfig.getInstance().getUid())) {
                    ToastUtil.show(com.yuanfen.video.R.string.video_comment_cannot_self);
                    return;
                }
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        public Vh(View itemView) {
            super(itemView);
            mName = (TextView) itemView.findViewById(com.yuanfen.video.R.id.name);
            mContent = (TextView) itemView.findViewById(com.yuanfen.video.R.id.content);
...
//                    mName.setTag(R.id.avatar, u.getId());
    ...
    class ParentVh extends Vh {
        ...
        public ParentVh(View itemView) {
            super(itemView);
            mBtnLike = (ImageView) itemView.findViewById(com.yuanfen.video.R.id.btn_like);
            mLikeNum = (TextView) itemView.findViewById(com.yuanfen.video.R.id.like_num);
            mBtnLike.setOnClickListener(mLikeClickListener);
            mAvatar = itemView.findViewById(com.yuanfen.video.R.id.avatar);
        }
    ...
    class ChildVh extends Vh {
        ...
        public ChildVh(View itemView) {
            super(itemView);
            mBtnGroup = itemView.findViewById(com.yuanfen.video.R.id.btn_group);
            mBtnExpand = itemView.findViewById(com.yuanfen.video.R.id.btn_expand);
            mBtnbCollapsed = itemView.findViewById(com.yuanfen.video.R.id.btn_collapsed);
